              ...
              <img alt="" src="/logo1.png" width="214" height="600" role="presentation"/>
                ...
                <Grid item align="center" style={{marginLeft:29.1, marginInlineEnd:28.19}} >
                 <h2 id="transition-modal-title">Join Medium</h2>
                    ...
                    <InputWithIcon/>
                    <Button style={{marginTop:"30px", color:"white", backgroundColor:"black" }} >Registration</Button>

                    <p >Already have an account? <SignInModal style={{color:"green"}}/></p>

                    <p style={{fontSize:"2dp", maxWidth:"27vw", color:"grey"}}>To make Medium work, we log user data and share it with service providers. Click “Sign Up” above to accept Medium’s <things/>Terms of Service & Privacy Policy.</p>
                </Grid>
