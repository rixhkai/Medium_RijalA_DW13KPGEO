  ...
  <div>
   ...
   <div align='center' style={{marginTop: "50px"}}>
    ...
    >
     ...
     <Grid item style={{width: "30px", marginLeft: "auto", textAlign: "right"}}>
      <br />
      <Button
       size='small'
       variant='outlined'
   ...
   <Container maxWidth='sm'>
    ...
    <div>
     <p style={{align: "start", alignItems: "start", maxWidth: "500px"}}>
      ...
      Bezel” options give you appealing app shelves to organize your home screen
      with; the “Hide Dock” wallpapers, well, hide the default shading behind
      your app dock, allowing colors and gradients to spill all the way to the
    ...
    {middleData.map(item => (
     <Grid className={classes.cards}>
      ...
      <Container align='right' maxWidth='xs'>
       <CardMedia className={classes.cover} image={item.img} />
      </Container>
     </Grid>
    ))}
   </Container>
